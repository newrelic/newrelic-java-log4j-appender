...
public class LogForwarder {
	...
	for (Map<String, Object> logEvent : logEvents) {
		...
		boolean added = logQueue.add(logEntry); // 1.1.0
    ...
    public void close(boolean mergeCustomFields, Map<String, Object> customFields) { // 1.1.0
